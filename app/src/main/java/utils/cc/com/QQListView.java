...
public class QQListView extends ListView {
    ...
    private TextView left_collent_item_delete;
    /**
     * 为删除按钮提供一个回调接口
     */
    ...
    public QQListView(Context context, AttributeSet attrs) {
        ...
        View view = mInflater.inflate(R.layout.left_txt_delete, null);
        left_collent_item_delete = view.findViewById(R.id.left_collent_item_delete);
        ...
        if (isSliding)
        {
            switch (action)
            {
                case MotionEvent.ACTION_MOVE:
                    ...
                    // 设置删除按钮的回调
                    left_collent_item_delete.setOnClickListener(new OnClickListener() {
                        @Override
                        public void onClick(View v)
                        {
                            if (mListener != null)
                            {
                                ...
                                Log.i(PublicUtils.AppName, "QQListView左滑删除");
