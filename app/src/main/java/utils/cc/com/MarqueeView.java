...
public class MarqueeView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextSize = typedArray.getDimensionPixelSize(R.styleable.MarqueeViewStyle_textSize, 37);
        ...
        itemAnimationTime = typedArray.getInteger(R.styleable.MarqueeViewStyle_itemAnimationTime, 2500);
